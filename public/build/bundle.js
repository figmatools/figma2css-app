...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file, 10, 2, 258);
    			attr_dev(input, "type", "checkbox");
    			add_location(input, file, 15, 8, 417);
    			add_location(span1, file, 15, 2, 411);
    			add_location(span2, file, 16, 2, 479);
    			attr_dev(li, "class", "list");
    			add_location(li, file, 9, 0, 237);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$1, 20, 0, 502);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label_1, file$2, 8, 2, 151);
    			...
    			input.required = true;
    			add_location(input, file$2, 9, 2, 189);
    			attr_dev(div, "class", "flex flex-column mr3 f7 w4");
    			add_location(div, file$2, 7, 0, 107);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 5, 0, 61);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	if (/*figmaToken*/ ctx[3] !== void 0) {
    		input0_props.value = /*figmaToken*/ ctx[3];
    	}
    	...
    	let input1_props = { label: "File Id*", id: "fileId" };

    	if (/*fileId*/ ctx[4] !== void 0) {
    		input1_props.value = /*fileId*/ ctx[4];
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(header, file$5, 83, 2, 2121);
    			attr_dev(button0, "class", "bn bg-green white br2 h2 f7 w5 pointer");
    			add_location(button0, file$5, 96, 4, 2595);
    			attr_dev(div0, "class", "flex items-end bb b--light-gray ph4 pv3");
    			add_location(div0, file$5, 93, 2, 2382);
    			attr_dev(input2, "css", input2_css_value = "border-box h2 input-reset ba br2 b--moon-gray pa0 pl2");
    			attr_dev(input2, "type", "file");
    			add_location(input2, file$5, 99, 4, 2788);
    			attr_dev(p, "class", "pa0 ma0 f7");
    			add_location(p, file$5, 101, 4, 2893);
    			attr_dev(button1, "class", "bn bg-green white br2 h2 f7 w5 pointer");
    			add_location(button1, file$5, 102, 4, 3012);
    			attr_dev(div1, "class", "flex items-center justify-between bb b--light-gray ph4 pv2");
    			add_location(div1, file$5, 98, 2, 2710);
    			attr_dev(div2, "class", "min-w6 bg-light-gray overflow-auto");
    			add_location(div2, file$5, 108, 4, 3191);
    			attr_dev(textarea, "class", "w-100 h-100");
    			add_location(textarea, file$5, 112, 6, 3350);
    			attr_dev(div3, "class", "w-100 h-100 pa3 flex justify-center");
    			add_location(div3, file$5, 111, 4, 3293);
    			attr_dev(div4, "class", "flex relative h-100 w-100");
    			add_location(div4, file$5, 107, 2, 3146);
    			add_location(footer, file$5, 116, 2, 3459);
    			add_location(main, file$5, 82, 0, 2111);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*loadTreeView*/ ctx[6], false, false, false),
    					listen_dev(input2, "change", /*input2_change_handler*/ ctx[13]),
    					listen_dev(button1, "click", /*generateCss*/ ctx[7], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_value && dirty & /*figmaToken*/ 8) {
    				updating_value = true;
    				input0_changes.value = /*figmaToken*/ ctx[3];
    			...
    			if (!updating_value_1 && dirty & /*fileId*/ 16) {
    				updating_value_1 = true;
    				input1_changes.value = /*fileId*/ ctx[4];
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	const generateCss = async () => {
    		...
    		try {
    			$$invalidate(5, resultCss = await (await fetch(`${baseUrl}/css?figmaToken=${figmaToken}&fileId=${fileId}&nodeIds=${checkedIds.join(",")}&filePath=./test.css&cssAttributes=fontFamily,fontSize,fontWeight`)).text());
    		} catch(err) {
    			console.error(err);
    		}
