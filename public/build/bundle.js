    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			p = element("p");
    			p.textContent = "Select a node and click generate!";
    			t6 = space();
    			button = element("button");
    			...
    			add_location(input2, file$5, 99, 4, 2455);
    			attr_dev(div1, "class", "flex items-end bb b--light-gray ph4 pv2");
    			add_location(div1, file$5, 98, 2, 2397);
    			attr_dev(p, "class", "pa0 ma0 f7");
    			add_location(p, file$5, 105, 8, 2744);
    			attr_dev(button, "class", "bn bg-green white br2 h2 f7 w3 pointer");
    			add_location(button, file$5, 106, 8, 2812);
    			attr_dev(div2, "class", "w5 flex pa2 items-center justify-between bg-washed-yellow");
    			add_location(div2, file$5, 104, 6, 2664);
    			add_location(div3, file$5, 111, 6, 2958);
    			attr_dev(div4, "class", "h-100 bg-light-gray overflow-auto");
    			add_location(div4, file$5, 103, 4, 2610);
    			attr_dev(textarea, "class", "w5 h5");
    			add_location(textarea, file$5, 116, 6, 3065);
    			attr_dev(div5, "class", "w-100 h-100 pa3");
    			add_location(div5, file$5, 115, 4, 3029);
    			attr_dev(div6, "class", "flex relative h-100 w-100");
    			add_location(div6, file$5, 102, 2, 2566);
    			add_location(footer, file$5, 120, 2, 3164);
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(treeview, div3, null);
    			append_dev(div6, t9);
